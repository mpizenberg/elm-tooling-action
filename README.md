...
> **v2 note:** This action runs on the `node24` runtime.
> Use a runner that ships Node.js 24 (GitHub-hosted runners do).
> If you are on an older runner without Node 24, stay on `@v1`.
